...
main:
    ...
    addi x23, x0, 1 # indica se é CFP(0) ou CNPJ(1)
...
primeiraparte:
    ...
    bne x15, x23, primeiraparte # enquanto nao chegar na posicao no limite de descrescimento, continua a parte
...
segundainteracao:
	...
	addi x12, x12, 4 # anda para o proximo algarismo do CPF/CNPJ
    bne x13, x23, segundainteracao  # enquanto nao chegar na posicao limite de descrescimento realiza novamente a funcao
...
verificadastro: 
	...
	addi x23, x0, 1 # o valor em que o vetor deve chegar para parar
